      ...
      <div className="relative z-10 flex flex-col h-full w-full">
        ...
        <div className="flex-1 overflow-y-auto w-full">
          <div className="max-w-[1600px] mx-auto p-4 md:p-8 space-y-8">
            ...
            <div className="space-y-4 text-center py-4 sm:py-8 px-2">
            ...
            <div className="flex flex-col h-full">
              ...
              <div className="flex gap-2 pb-6 overflow-x-auto scrollbar-hide">
                <button
                  ...
                  className={`px-4 py-2 rounded-full text-sm whitespace-nowrap ${filter === "all"
                ...
                {Array.from(new Set(tools.map(tool => tool.category))).map(category => {
                  ...
                  return (
                    <button
                      ...
                      className={`px-4 py-2 rounded-full text-sm whitespace-nowrap ${filter === category
                          ? "bg-gray-700 text-white"
                          : "bg-gray-800 text-gray-300 hover:bg-gray-700"
                        }`}
                    >
